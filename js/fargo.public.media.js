...
function ShowMovieInfo(id)
{
    ...
    ({
        ...
        {   
            ...
            $("#info_video").html(json.video);
            $("#info_audio").html(json.audio);
            $("#info_aspect").html(json.aspect);
            ...
            */
            ...
            //$("#info_box .url").remove();
            if (json.imdbnr){
               buttons += '<button type="button" class="url" value="' + json.imdbnr + '">IMDb</button>';
            }
            
            if (json.trailer){
               buttons += '<button type="button" class="url" value="' + json.trailer + '">Trailer</button>';
            }
...
function ShowAlbumInfo(id)
{
    ...
    ({
        ...
        {              
            ...
            .attr('src', 'images/music/covers/' + json.xbmcid + '.jpg')
            .css("width", 280);
