...
insert  into `status`(`id`,`name`,`value`) values (1,'ImportStart','1'),(2,'ImportEnd','8'),(3,'ImportCounter','1'),(4,'ImportStatus','-1'),(5,'ImportKey','3f69ebabdb01345656069c8f4934dc3d2206303301fc81ab34e0f4cde2b801de'),(6,'ImportLock','-1');
