...
class XBMC_RPC_HTTPClient extends XBMC_RPC_Client {
    ...
    protected function sendRequest($json, $rpcId) {
        ...
        // Added this line to make RPC compatible with XBMC's FRODO.
        curl_setopt($this->curlResource, CURLOPT_HTTPHEADER, array("Content-Type: application/json", "Content-length: ".strlen($json)));
